...
const AboutPage: React.FC = () => {
  const services: ServiceItem[] = [
    { 
      icon: FiPenTool, 
      title: "Studio Design", 
      desc: "Conception graphique stratégique pour aligner vos supports avec vos objectifs commerciaux." 
    },
    { 
      icon: FiTarget, 
      title: "Solutions Corporate", 
      desc: "De la signalétique au textile, une cohérence visuelle parfaite sur tous vos points de contact." 
    },
    { 
      icon: FiZap, 
      title: "Flux Intelligents", 
      desc: "Intégration de workflows automatisés via n8n pour une gestion de commande transparente et sans erreur." 
    },
  ];
 ...
 <section className="relative py-32 md:py-12 bg-slate-900 text-white overflow-hidden">
  ...
  <div className="absolute inset-0 z-0">
    ...
    />
    {/* Overlay Gradient: Assure la lisibilité du texte à gauche */}
  ...
  <div className="max-w-7xl mx-auto px-6 relative z-10">
    <div className="max-w-3xl">
      ...
      <p className="text-slate-300 text-lg md:text-xl leading-relaxed mb-10 font-medium max-w-xl">
        ...
        Performance industrielle, finitions artisanales.
      </p>
        ...
        <div className="grid lg:grid-cols-12 gap-16 items-start">
          <div className="lg:col-span-5">
            ...
            <p className="text-slate-600 text-lg mb-8 leading-relaxed">
              ...
              Nem's Service fusionne les techniques traditionnelles d'impression avec les technologies de personnalisation les plus avancées.
            </p>
          ...
          <div className="lg:col-span-7 grid grid-cols-2 gap-4">
            <div className="space-y-4">
              <img src="https://images.unsplash.com/photo-1504384308090-c894fdcc538d?q=80&w=800" className="rounded-2xl shadow-lg w-full h-64 object-cover grayscale hover:grayscale-0 transition-all duration-700" alt="Corporate Setup" />
              <img src="https://images.unsplash.com/photo-1586075010633-2445198ba293?q=80&w=800" className="rounded-2xl shadow-lg w-full h-80 object-cover" alt="Quality Control" />
            </div>
            <div className="space-y-4 pt-12">
              <img src="https://images.unsplash.com/photo-1558655146-d09347e92766?q=80&w=800" className="rounded-2xl shadow-lg w-full h-80 object-cover" alt="Focus Detail" />
              <img src="https://images.unsplash.com/photo-1614850523296-d8c1af93d400?q=80&w=800" className="rounded-2xl shadow-lg w-full h-64 object-cover grayscale hover:grayscale-0 transition-all duration-700" alt="Final Product" />
            </div>
          </div>
        </div>
      </section>

      {/* --- Professional Stats: Somber & Minimal --- */}
      ...
      <section className="py-32 bg-slate-50">
        <div className="max-w-7xl mx-auto px-6 text-center mb-20">
          <h2 className="text-xs font-black text-blue-600 uppercase tracking-[0.3em] mb-4 text-center">Infrastructures</h2>
          <h3 className="text-4xl font-bold tracking-tight">Expertises Dédiées</h3>
        </div>
